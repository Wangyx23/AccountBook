 ...
 */
public class TwoFragmentcopy extends Fragment {
    ...
    private void initPieChart(View v){
        CategorySeries dataset = buildCategoryDataset("PieChart", values);
    ...
    protected CategorySeries buildCategoryDataset(String title, double[] values){
        ...
        series.add("sports:"+values[0], values[0]/sumVal);
        series.add("leisure:"+values[1], values[1]/sumVal);
        series.add("food:"+values[2], values[2]/sumVal);
